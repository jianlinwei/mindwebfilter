...
private:
    ...
    void requestChecks(HTTPHeader *header, ContentFilter *checkme, String *urld, std::string *clientip,
    ...
    bool denyAccess(Socket *peerconn, Socket *proxysock, HTTPHeader *header, HTTPHeader *docheader,
            String *url, ContentFilter *checkme, std::string *clientuser, std::string *clientip,
    ...
    void contentFilter(HTTPHeader *docheader, HTTPHeader *header, DataBuffer *docbody, Socket *proxysock,
            Socket *peerconn, int *headersent, bool *pausedtoobig, off_t *docsize, ContentFilter *checkme, bool runav,
