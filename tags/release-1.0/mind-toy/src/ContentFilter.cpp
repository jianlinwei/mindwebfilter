...
void ContentFilter::checkme(DataBuffer *body, String &url, String &domain)
{
	// original data
...
void ContentFilter::checkphrase(char *file, off_t l, String *url, String *domain)
{
	int weighting = 0;
	int cat;
...
void ContentFilter::checkPICS(char *file)
{
...
void ContentFilter::checkPICSrating(std::string label)
{
...
void ContentFilter::checkPICSagainstoption(String s, const char *l, int opt, std::string m)
{
	if (s.indexOf(l) != -1) {
...
// Korean PICS
void ContentFilter::checkPICSratingICEC(String r) {
    checkPICSagainstoption(r, "y ", (*o.fg[filtergroup]).pics_icec_rating, "ICEC rating");
}

// Korean PICS
void ContentFilter::checkPICSratingSafeNet(String r) {
...
void ContentFilter::checkPICSratingRSAC(String r)
{
...
void ContentFilter::checkPICSratingVancouver(String r)
{
...
void ContentFilter::checkPICSratingSafeSurf(String r)
{
...
void ContentFilter::checkPICSratingICRA(String r)
{
