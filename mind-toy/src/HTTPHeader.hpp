...
#define __MIND_HEADER_SENDALL 0
#define __MIND_HEADER_SENDFIRSTLINE 1
#define __MIND_HEADER_SENDREST 2
...
private:
	...
	bool dirty;
        ...
        // Check & Modify headers from/to server.
	void modifyHeaders(bool allowpersistent);
        void modifyClientHeader(bool allowpersistent);
        void modifyServerHeader(bool allowpersistent);
