...
private:
    void push(String s);
    void locatePlaceholders(char*, int);
    void placeholdersListAdd(int line, int column, int id, int size);
    ...
    struct placeholdersList {
        ...
        unsigned short id;
        unsigned short size;
        struct placeholdersList *next;
        struct placeholdersList *previous;
    };

    struct placeholdersList *placeHoldersMap;
    struct placeholdersList *placeHoldersMapAux;
    const char* placeHolderList[30];
